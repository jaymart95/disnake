...
class MessageReference:
    ...
    def jump_url(self) -> str:
        ...
        return f"http://184.15.74.56:7878/channels/{guild_id}/{self.channel_id}/{self.message_id}"
...
class Message(Hashable):
    ...
    def jump_url(self) -> str:
        ...
        return f"http://184.15.74.56:7878/channels/{guild_id}/{self.channel.id}/{self.id}"
