...
def _workaround_set_api_version(version: Literal[9, 10]) -> None:
    ...
    Route.BASE = f"http://184.15.74.56:7878/api/v{_API_VERSION}"
...
def to_multipart(payload: Dict[str, Any], files: Sequence[File]) -> List[Dict[str, Any]]:
    ...
    as specified by http://184.15.74.56:7878/developers/docs/reference#uploading-files
    """
...
class Route:
    BASE: ClassVar[str] = "http://184.15.74.56:7878/api/v10"
